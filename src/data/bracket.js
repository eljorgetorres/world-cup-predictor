...
export const R32_MATCHES = [
  {
    id: 73,
    slot1: { type: 'runner-up', group: 'A' },
    slot2: { type: 'runner-up', group: 'B' },
  },
  {
    id: 74,
    slot1: { type: 'winner',   group: 'E' },
    slot2: { type: 'best-3rd', eligibleGroups: ['A', 'B', 'C', 'D', 'F'] },
  },
  {
    id: 75,
    slot1: { type: 'winner',   group: 'F' },
    slot2: { type: 'runner-up', group: 'C' },
  },
  {
    id: 76,
    slot1: { type: 'winner',   group: 'C' },
    slot2: { type: 'runner-up', group: 'F' },
  },
  {
    id: 77,
    slot1: { type: 'winner',   group: 'I' },
    slot2: { type: 'best-3rd', eligibleGroups: ['C', 'D', 'F', 'G', 'H'] },
  },
  {
    id: 78,
    slot1: { type: 'runner-up', group: 'E' },
    slot2: { type: 'runner-up', group: 'I' },
  },
  {
    id: 79,
    slot1: { type: 'winner',   group: 'A' },
    slot2: { type: 'best-3rd', eligibleGroups: ['C', 'E', 'F', 'H', 'I'] },
  },
  {
    id: 80,
    slot1: { type: 'winner',   group: 'L' },
    slot2: { type: 'best-3rd', eligibleGroups: ['E', 'H', 'I', 'J', 'K'] },
  },
  {
    id: 81,
    slot1: { type: 'winner',   group: 'D' },
    slot2: { type: 'best-3rd', eligibleGroups: ['B', 'E', 'F', 'I', 'J'] },
  },
  {
    id: 82,
    slot1: { type: 'winner',   group: 'G' },
    slot2: { type: 'best-3rd', eligibleGroups: ['A', 'E', 'H', 'I', 'J'] },
  },
  {
    id: 83,
    slot1: { type: 'runner-up', group: 'K' },
    slot2: { type: 'runner-up', group: 'L' },
  },
  {
    id: 84,
    slot1: { type: 'winner',   group: 'H' },
    slot2: { type: 'runner-up', group: 'J' },
  },
  {
    id: 85,
    slot1: { type: 'winner',   group: 'B' },
    slot2: { type: 'best-3rd', eligibleGroups: ['E', 'F', 'G', 'I', 'J'] },
  },
  {
    id: 86,
    slot1: { type: 'winner',   group: 'J' },
    slot2: { type: 'runner-up', group: 'H' },
  },
  {
    id: 87,
    slot1: { type: 'winner',   group: 'K' },
    slot2: { type: 'best-3rd', eligibleGroups: ['D', 'E', 'I', 'J', 'L'] },
  },
  {
    id: 88,
    slot1: { type: 'runner-up', group: 'D' },
    slot2: { type: 'runner-up', group: 'G' },
  },
];
